...
class UserController extends Controller
{
    ...
    {
        //
        $response['users'] = User::where('level', '!=', 'Usuário Normal')->get();

        $response['users_normal'] = User::where('level', 'Usuário Normal')->get();
    ...
    public function approve($id)
    {
        ...
        Mail::to($user->email)->send(new UserApproved($user, $plainPassword));

        return redirect()->route('admin.user.index')->with('approved', '1');
    }
}
