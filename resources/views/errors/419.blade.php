                ...
                <div class="row vh-100">
                    ...
                    <div class="position-absolute col-md-8 col-lg-6 col-xl-4 center ml-lg-n9">
                        <div class="square d-flex w-100 mt-5">
                            <div
                                class="square-innerpb-4 pt-6 bg-primary text-white mx-auto p-4 p-lg-6 d-flex flex-column justify-content-center">
                                <h1>419</h1>
                                <p class=mb-6>Página Expirada, actualize a página!</p>
