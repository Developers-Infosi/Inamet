...
<head>
    ...
    <link href="/assets/images/logo/logo.png" rel="shortcut icon" type="image/x-icon">
...
<body>
    <div class="container-login100" style="background-image: url('/site/images/hearth.jpg');">
        <div class="wrap-login100 p-l-55 p-r-55 p-t-80 p-b-30">
            <form class="login100-form validate-form" method="POST" action="{{ route('login') }}">
                ...
                <div class="container-login100-form-btn">
                    ...
                    <small class="my-3"><a href="{{ route("password.request") }}"><b>Esqueceu a sua palavra passe ?</b></a></small>
                </div>
