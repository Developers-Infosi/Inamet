    ...
    <main>
        <section class="pb-4 pt-6 bg-green" id=content>
            <div class=container>
                <div class=row>
                    <div class=col>
                        <h1 class="text-white my-5">Covid-19 </h1>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="row py-5 my-5">
                ...
                <div class="col-md-12">
                    ...
                    <p>Relativamente a entradas e saídas no país (Angola), de acordo com o Decreto Presidencial nº 152/23 de
                        ...
                        fronteiras</p>
                    <ul>
                        <li> <b>Passo 1  –</b> São livres as entradas e saídas do território nacional, não estando
                            dependentes da
                            apresentação de Certificado de Vacinação, nem da apresentação de resultado negativo de teste do
                            Vírus SARS-CoV-2.</li><br>
                        <li><b>Passo 2  – </b> Sem prejuízo do disposto no número anterior, as saídas do território nacional
                            podem estar sujeitas às exigências de vigilância sanitária definidas pelo país de destino.</li>
                    </ul><br><br>
