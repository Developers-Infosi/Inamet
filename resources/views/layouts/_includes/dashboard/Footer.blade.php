<footer class="py-1 mt-4pb-4 pt-6  color-bg">

    <p class="text-center mt-3 text-white">
        <span>&copy; {{ date('Y') }}, Portal do Instituto Nacional de Metereologia e Geofísica</span> by <a href="https://infosi.gov.ao/" target="_blank" class="text-white">INFOSI</a>
    </p>
</footer>
@if (session('create'))
    <script>
