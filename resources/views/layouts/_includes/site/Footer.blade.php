  ...
  <section id="footer_top">
    <div class="container">
       ...
       <div class="col">
        ...
        <h1>Links úteis</h1>
        <ul>
             <li><a href="https://governo.gov.ao/" target="_blank">  Portal do Governo de Angola</a></li>
              <li><a href="https://minttics.gov.ao/ao/" target="_blank">  Minttics</a></li>
               <li><a href="https://www.infosi.gov.ao/" target="_blank">  Infosi</a></li>
            <li><a href="https://angolahoje.ao/" target="_blank">  Angola Hoje</a></li>
        ...
        <div class="block_rs">
            ...
            >
                <span id="block-publicmenusocial-menu">Suivez-nous</span>
                            <div style="color:#fff; text-align:center;padding-block:1rem;">
                                <p>
                                © {{ Date("Y") }} Copyright -
                                <a style="color: #fff" href="{{ route("site.home") }}">INAMET</a>
                            </p>
                            </div>
            </nav>
        </div>
    ...
    <script>
      Fancybox.bind('[data-fancybox="gallery"]', {
       ...
       Fancybox.bind('[data-fancybox="gallery-river"]', {
        //
      });    
    </script>
